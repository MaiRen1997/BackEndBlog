---
title: (3-2)定时任务同步
date: 2026-08-12 16:22:15
permalink: /pages/e78ebc/
categories:
  - FastApi文档
  - sql数据库定时同步
tags:
...
from module_task.cbus_sync_job import sync_cbus_from_sqlserver_full
...
class SchedulerUtil:
    ...
    def _register_internal_jobs(cls) -> None:
        ...
        """
        scheduler.add_job(
            func=sync_cbus_from_sqlserver_full,
            trigger='cron',
            hour='*/2',
            minute='0',
            id='_cbus_sqlserver_sync',
            name='CBUS SQLServer数据同步',
            replace_existing=True,
        )
